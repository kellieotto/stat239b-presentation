...
\item As far as we know, this is true, but it is not really of interest because unbiasedness seems not to have any  relationship to the consistency of the bootstrap and it is easy to construct much simpler examples satisfying stronger bias conditions.
