...
\item For example the critical value of Wilcoxon rank-sum and signed rank tests is often approximated using the bootstrap when ties are present in the data.
\eit
}
...
\item Formalizing this requires a notion of smoothness of random quantities called Fr\'{e}chet differentiability, but will elide it.
\eit
}
\frame{
\frametitle{Placing Abadie and Imbens in the literature}
...
\item But it is valuable because it informs practitioners one of the (many) limitations of the bootstrap. 
